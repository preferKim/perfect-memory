...
import { ArrowLeft, BookCheck, Shield, Star } from 'lucide-react';
import Button from '../components/Button';

const SocialSelectionScreen = ({ user }) => {
    const navigate = useNavigate();

    const handleLevelSelect = (difficulty) => {
        navigate(`/social/${difficulty}`);
    };
        ...
        <div className="glass-card p-6 sm:p-12 text-center relative">
            ...
            <div className="mb-6 mt-8">
                <p className="text-2xl font-bold text-white mb-6">
                    <span className="inline-block border-b-2 border-primary-light pb-1">사회 (Social Studies)</span>
                </p>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-10">
                    ...
                    >
                        <BookCheck size={32} className="mb-2" />
                        초등<br/>(기본 다지기)
                    </Button>
                    <Button
